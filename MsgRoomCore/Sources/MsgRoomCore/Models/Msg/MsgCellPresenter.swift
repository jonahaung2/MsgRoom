...
public struct MsgCellPresenter: Conformable {
    public var id: MsgCellPresenter { self }
    ...
    public init(content: Content, isSender: Bool, bubbleShape: BubbleShape, showAvatar: Bool, showTimeSeparater: Bool, showTopPadding: Bool, isSelected: Bool, blurredRadius: CGFloat, bubbleColor: Color, textColor: Color? = nil, senderURL: String? = nil, senderName: String? = nil) {
