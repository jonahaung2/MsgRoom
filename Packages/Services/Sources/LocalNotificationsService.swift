...
public enum LocalNotificationsService {
    public static func fireAlertMessage(title: String, subtitle: String, body: String) {
        self.post(title: title, subtitle: subtitle, body: body, sound: .init(named: UNNotificationSoundName(rawValue: "notification.wav")))
    }
    public static
    ...
    private static func _post(title: String,
                              subtitle: String,
                              body: String,
                              badge: NSNumber? = nil,
                              sound: UNNotificationSound? = .default,
