...
extension Button {
    ...
    public func softButtonStyle<S : Shape>(_ content: S, padding : CGFloat = 16, mainColor : Color = Color.Shadow.main, textColor : Color = Color.Shadow.secondary, darkShadowColor: Color = Color.Shadow.darkShadow, lightShadowColor: Color = Color.Shadow.lightShadow, pressedEffect : SoftButtonPressedEffect = .hard) -> some View {
