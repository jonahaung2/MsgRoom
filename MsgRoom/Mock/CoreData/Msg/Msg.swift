...
public extension Msg {
    static func create(
        ...
        switch await repo.create(msg, transactionAuthor: "me") {
...
extension Msg {
    ...
    public init(managed: RepoMsg) throws {
        self.init(id: managed.id, conID: managed.conID, msgKind: managed.msgKind, senderID: managed.senderID, date: managed.date, deliveryStatus: managed.deliveryStatus, text: managed.text, managedIdUrl: managed.objectID.uriRepresentation())
    }
}
